...
int TestSqEq(const DO_SquareSolverTest test)
{
 ...
 int testAll()
 {
    DO_SquareSolverTest allData[] ={{.a = 1, .b =  0, .c = -4, .n_scanf = 3, .x1_ref =  +2, .x2_ref =  -2, .nRoots_ref =          TWO_ROOTS},
                                    ...
                                    {.a = 1, .b =  2, .c =  1, .n_scanf = 3, .x1_ref =  -1, .x2_ref = NAN, .nRoots_ref =           ONE_ROOT},
                                    {.a = 1, .b =  5, .c =  6, .n_scanf = 3, .x1_ref =  -2, .x2_ref =  -3, .nRoots_ref =          TWO_ROOTS}};
